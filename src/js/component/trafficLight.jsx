...
const TrafficLihgt =()=> {
 ...
 <div onClick={()=>{
    SetColor("purple")}} className={"rounded-circle m-1"+ (color=="purple"? "onLightPurple":"")} style={{width:"100px", height:"100px", backgroundColor:" #6f42c1"}}></div>)
    return(
    ...
    <div onClick={()=>{
        SetColor("red")
    }} className={"bg-danger rounded-circle m-1 " + (color=="red"? "onLightRed":"")} style={{width:"100px", height:"100px"}}></div>
        <div onClick={()=>{
        SetColor("yellow")
    }} className={"bg-warning rounded-circle m-1" + (color=="yellow"? "onLightYellow":"")} style={{width:"100px", height:"100px"}}></div>
        <div onClick={()=>{
        SetColor("green")
    }} className={"bg-success rounded-circle m-1" + (color=="green"? "onLightGreen":"")}style={{width:"100px", height:"100px"}}></div>
